...
DEFAULT_COINS: List[str] = [
    ...
    "FIOUSDT",     "FLOKIUSDT",     "FLOWUSDT",     "FLUXUSDT",     "FORMUSDT",
    "FORTHUSDT",     "FTTUSDT",     "FUNUSDT",     "FUSDT",     "FXSUSDT",
    "GALAUSDT",     "GASUSDT",     "GHSTUSDT",     "GIGGLEUSDT",     "GLMRUSDT",
    "GLMUSDT",     "GMTUSDT",     "GMXUSDT",     "GNOUSDT",     "GNSUSDT",
    "GPSUSDT",     "GRTUSDT",     "GTCUSDT",     "GUNUSDT",     "GUSDT",
    "HAEDALUSDT",     "HBARUSDT",     "HEIUSDT",     "HEMIUSDT",     "HFTUSDT",
    "HIGHUSDT",     "HIVEUSDT",     "HMSTRUSDT",     "HOLOUSDT",     "HOMEUSDT",
    "HOOKUSDT",     "HOTUSDT",     "HUMAUSDT",     "HYPERUSDT",     "ICPUSDT",
    "ICXUSDT",     "IDEXUSDT",     "IDUSDT",     "ILVUSDT",     "IMXUSDT",
    "INITUSDT",     "INJUSDT",     "IOSTUSDT",     "IOTAUSDT",     "IOTXUSDT",
    "IOUSDT",     "IQUSDT",     "JASMYUSDT",     "JOEUSDT",     "JSTUSDT",
    "JTOUSDT",     "JUPUSDT",     "JUVUSDT",     "KAIAUSDT",     "KAITOUSDT",
    "KAVAUSDT",     "KERNELUSDT",     "KGSTUSDT",     "KITEUSDT",     "KMNOUSDT",
    "KNCUSDT",     "KSMUSDT",     "LAUSDT",     "LAYERUSDT",     "LAZIOUSDT",
    "LDOUSDT",     "LINEAUSDT",     "LINKUSDT",     "LISTAUSDT",     "LPTUSDT",
    "LQTYUSDT",     "LRCUSDT",     "LSKUSDT",     "LTCUSDT",     "LUMIAUSDT",
    "LUNAUSDT",     "LUNCUSDT",     "MAGICUSDT",     "MANAUSDT",     "MANTAUSDT",
    "MASKUSDT",     "MAVUSDT",     "MBLUSDT",     "MBOXUSDT",     "MDTUSDT",
    "MEMEUSDT",     "METISUSDT",     "METUSDT",     "MEUSDT",     "MINAUSDT",
    "MIRAUSDT",     "MITOUSDT",     "MLNUSDT",     "MMTUSDT",     "MORPHOUSDT",
    "MOVEUSDT",     "MOVRUSDT",     "MTLUSDT",     "MUBARAKUSDT",     "NEARUSDT",
    "NEIROUSDT",     "NEOUSDT",     "NEWTUSDT",     "NEXOUSDT",     "NFPUSDT",
    "NILUSDT",     "NKNUSDT",     "NMRUSDT",     "NOMUSDT",     "NOTUSDT",
    "NTRNUSDT",     "NXPCUSDT",     "OGNUSDT",     "OGUSDT",     "OMUSDT",
    "ONDOUSDT",     "ONEUSDT",     "ONGUSDT",     "ONTUSDT",     "OPENUSDT",
    "OPUSDT",     "ORCAUSDT",     "ORDIUSDT",     "OSMOUSDT",     "OXTUSDT",
    "PARTIUSDT",     "PAXGUSDT",     "PENDLEUSDT",     "PENGUUSDT",     "PEOPLEUSDT",
    "PEPEUSDT",     "PHAUSDT",     "PHBUSDT",     "PIVXUSDT",     "PIXELUSDT",
    "PLUMEUSDT",     "PNUTUSDT",     "POLUSDT",     "POLYXUSDT",     "PONDUSDT",
    "PORTALUSDT",     "PORTOUSDT",     "POWRUSDT",     "PROMUSDT",     "PROVEUSDT",
    "PSGUSDT",     "PUMPUSDT",     "PUNDIXUSDT",     "PYRUSDT",     "PYTHUSDT",
    "QIUSDT",     "QKCUSDT",     "QNTUSDT",     "QTUMUSDT",     "QUICKUSDT",
    "RADUSDT",     "RAREUSDT",     "RAYUSDT",     "RDNTUSDT",     "REDUSDT",
    "RENDERUSDT",     "REQUSDT",     "RESOLVUSDT",     "REZUSDT",     "RIFUSDT",
    "RLCUSDT",     "RONINUSDT",     "ROSEUSDT",     "RPLUSDT",     "RSRUSDT",
    "RUNEUSDT",     "RVNUSDT",     "SAGAUSDT",     "SAHARAUSDT",     "SANDUSDT",
    "SANTOSUSDT",     "SAPIENUSDT",     "SCRTUSDT",     "SCRUSDT",     "SCUSDT",
    "SEIUSDT",     "SFPUSDT",     "SHELLUSDT",     "SHIBUSDT",     "SIGNUSDT",
    "SKLUSDT",     "SKYUSDT",     "SLPUSDT",     "SNXUSDT",     "SOLUSDT",
    "SOLVUSDT",     "SOMIUSDT",     "SOPHUSDT",     "SPELLUSDT",     "SPKUSDT",
    "SSVUSDT",     "STEEMUSDT",     "STGUSDT",     "STORJUSDT",     "STOUSDT",
    "STRAXUSDT",     "STRKUSDT",     "STXUSDT",     "SUIUSDT",     "SUNUSDT",
    "SUPERUSDT",     "SUSDT",     "SUSHIUSDT",     "SXPUSDT",     "SXTUSDT",
    "SYNUSDT",     "SYRUPUSDT",     "SYSUSDT",     "TAOUSDT",     "TFUELUSDT",
    "THETAUSDT",     "THEUSDT",     "TIAUSDT",     "TKOUSDT",     "TLMUSDT",
    "TNSRUSDT",     "TONUSDT",     "TOWNSUSDT",     "TRBUSDT",     "TREEUSDT",
    "TRUMPUSDT",     "TRUUSDT",     "TRXUSDT",     "TSTUSDT",     "TURBOUSDT",
    "TURTLEUSDT",     "TUSDT",     "TUSDUSDT",     "TUTUSDT",     "TWTUSDT",
    "UMAUSDT",     "UNIUSDT",     "USD1USDT",     "USDCUSDT",     "USDEUSDT",
    "USDPUSDT",     "USTCUSDT",     "USUALUSDT",     "UTKUSDT",     "VANAUSDT",
    "VANRYUSDT",     "VELODROMEUSDT",     "VETUSDT",     "VICUSDT",     "VIRTUALUSDT",
    "VTHOUSDT",     "WALUSDT",     "WANUSDT",     "WAXPUSDT",     "WBETHUSDT",
    "WBTCUSDT",     "WCTUSDT",     "WIFUSDT",     "WINUSDT",     "WLDUSDT",
    "WLFIUSDT",     "WOOUSDT",     "WUSDT",     "XAIUSDT",     "XECUSDT",
    "XLMUSDT",     "XNOUSDT",     "XPLUSDT",     "XRPUSDT",     "XTZUSDT",
    "XUSDUSDT",     "XVGUSDT",     "XVSUSDT",     "YBUSDT",     "YFIUSDT",
    "YGGUSDT",     "ZBTUSDT",     "ZECUSDT",     "ZENUSDT",     "ZILUSDT",
    "ZKCUSDT",     "ZKPUSDT",     "ZKUSDT",     "ZROUSDT",     "ZRXUSDT",
    "币安人生USDT",
]
