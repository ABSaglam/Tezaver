...
def _render_live_section_v2(rows: List[ProfileBoardRow]) -> None:
    ...
    # =========================================================================
    if _is_allowed("🔁 Live Loop Control | Canlı Döngü Kontrolü"):
    ...
    # =========================================================================
    if _is_allowed("🩺 System Health Summary | Sistem Sağlık Özeti"):
    ...
    # =========================================================================
    if _is_allowed("📦 Incident Bundles | Olay Paketi Arşivi"):
    ...
    # E3) Events Explorer
    # =========================================================================
    if _is_allowed("📊 Events Explorer | Olay Gezgini"):
    ...
    # =========================================================================
    if _is_allowed("🎬 Trade Replay | İşlem Tekrarı"):
    ...
    # =========================================================================
    if _is_allowed("🟢 Live Freshness / Lag | Canlı Veri Tazeliği"):
    ...
    # =========================================================================
    if _is_allowed("📊 Cycles Report | Döngü Raporu"):
    ...
    # =========================================================================
    if _is_allowed("✅ Closed Bar Proof | Kapalı Bar Kanıtı"):
    ...
    # =========================================================================
    if _is_allowed("🧹 Dust & Position Hygiene | Bakiye & Pozisyon Temizliği"):
    ...
    if _is_allowed("🔀 Closed-bar Router | Kapalı Bar Yönlendiricisi"):
    ...
    # =========================================================================
    if _is_allowed("🧾 Proof+Router (E2E) | Kanıt+Yönlendirici (Uçtan Uca)"):
    ...
    # =========================================================================
    if _is_allowed("🧾 Proof+Router+Cluster (E2E) | Kanıt+Yönlendirici+Küme (Uçtan Uca)"):
    ...
    # 🧭 Live Ops Console
    # =========================================================================
    if _is_allowed("🧭 Live Ops Console | Canlı Operasyon Konsolu"):
    ...
    # =========================================================================
    if _is_allowed("⚙️ Exchange & Arm Controls | Borsa & Yetkilendirme Kontrolleri"):
...
export BINANCE_API_SECRET=your_api_secret_here""", language="bash")
    ...
    # =========================================================================
    if _is_allowed("🎮 Live Gate Status | Canlı Kapı Durumu"):
    ...
    # NDJSON Tail Viewer
    # =========================================================================
    if _is_allowed("📜 NDJSON Tail Viewer | NDJSON Log Görüntüleyici"):
    ...
    # =========================================================================
    if _is_allowed("🧾 Last Orders (per cell) | Son Emirler (hücre bazında)"):
