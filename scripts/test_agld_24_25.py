...
def scan_agld_multi_year():
    symbol = "AGLDUSDT"
    print(f"🕵️ Multi-Year Audit for {symbol} (2024-2025)")
    print("="*80)
    ...
    # Identify PASS days in 2024 and 2025
    pass_days = []
    df_1d_target = df_1d[df_1d.index.year.isin([2024, 2025])]
    ...
    print(f"🚇 Found {len(pass_days)} Ayaş Tüneli days in 2024-2025.")
