"""
AUDIOUSDT Threshold Sweep
=========================
Audius - Web3 Music
Pattern Discovery:
mom_7d: -1.28% avg (Negatif) -> Dip/Rebound? 📉
mom_3d: -0.18% avg (Negatif)
daily_ch: +0.16% avg (Nötr/Hafif Pozitif)

Momentum negatifken rally başlıyor.
Demek ki AUDIO, "Düştükçe Al" coini olabilir.

Test:
Dip Buying Stratejileri (mom <= -X, daily_ch <= -X)
"""
...
def main():
    symbol = 'AUDIOUSDT'
    print(f"🔬 {symbol} (Audius) Threshold Sweep - Dip/Rebound")
    ...
    print("\n" + "="*70)
    print("🔬 AUDIO Strateji Testleri")
    print("="*70)
    
    # Test 1: Weekly Dip (mom_7d)
    print("\n📊 Test 1: Weekly Dip (mom_7d):")
