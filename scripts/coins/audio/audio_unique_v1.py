"""
AUDIOUSDT Unique Strategy V1 (Final)
=====================================
Audius - Music Rebounder

GİZEM: Düşüşü Satın Al (Buy the Weekly Dip) 📉
mom_7d <= -2% (112 Sinyal) -> %100 Kesinlik!

AUDIO, Launchpad coinlerinin aksine, yükselirken değil düşerken alınmalı.
Haftalık momentum negatif (-%2) olduğunda, yani coin "kırmızı" göründüğünde
aslında bir sonraki rally için enerji topluyor demektir.
Tam bir "Reversal" veya "Dip Rebound" karakteri.
...
def main():
    symbol = 'AUDIOUSDT'
    print(f"🎯 {symbol} (Audius) UNIQUE STRATEGY V1")
    ...
    if not df.empty:
        ...
        print(f"📉 AUDIO Gizi: Haftalık %2 üzeri düşüşlerde (Kırmızı) alım fırsatı! (112 Sinyal)")
