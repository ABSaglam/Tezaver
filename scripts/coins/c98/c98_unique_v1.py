"""
C98USDT Unique Strategy V1 (Final)
===================================
Coin98 - Ultra Quiet Momentum

GİZEM: Uyuyan Dev (Sleeping Giant) 😴
mom_3d >= 0% (111 Sinyal) -> %100 Kesinlik!

C98, en düşük hassasiyetli momentum coini!
Rally öncesi sadece "negatif olmaması" yeterli.
mom_3d >= 0% = Sadece düşüş yok.
...
def main():
    symbol = 'C98USDT'
    print(f"🎯 {symbol} (Coin98) UNIQUE STRATEGY V1")
    ...
    for idx in range(25, len(df_1d)-1):
        ...
        if row['mom_3d'] >= 0:
            ...
            if next_date in rally_results:
                ...
                if len(signals) <= 20 or len(signals) > 105:
    ...
    if not df.empty:
        ...
        print(f"😴 C98 Gizi: 3 günlük momentum %0 veya üstünde = Dev uyanıyor. (111 Sinyal)")
