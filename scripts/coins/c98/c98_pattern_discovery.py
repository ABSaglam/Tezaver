...
C98USDT - Gizem Keşfi
======================
Coin98 - Multi-chain Wallet/DeFi
Tahmini Rally Sayısı: Bilinmiyor (Kontrol edilecek)
Multi-chain DeFi platformu.
DeFi momentum coini mi?
...
def main():
    symbol = 'C98USDT'
    print(f"🔍 {symbol} (Coin98) - Multi-chain DeFi Gizemi...")
    ...
    if not rally_df.empty:
        print("\n" + "="*70)
        print("⚡ AYIRICI GÜÇ - C98 Farklı mı?")
        print("="*70)
