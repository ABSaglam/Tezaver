"""
ARKMUSDT Unique Strategy V1 (Final)
====================================
Arkham - AI Data Micro-Momentum

GİZEM: Mikro-Momentum (High Sensitivity) 🧠
mom_3d >= 1% (141 Sinyal) -> %100 Kesinlik!

ARKM, çok hassas bir trend takipçisi.
3 günlük dönemde sadece %1'lik bir artış bile (%1 pozitif kapanış)
yeni bir rally'nin habercisi oluyor.
Eşik çok düşük ama güvenilirlik tam.
...
def main():
    symbol = 'ARKMUSDT'
    print(f"🎯 {symbol} (Arkham) UNIQUE STRATEGY V1")
    ...
    for idx in range(25, len(df_1d)-1):
        ...
        if row['mom_3d'] >= 1:
            ...
            if next_date in rally_results:
                ...
                if len(signals) <= 20 or len(signals) > 120:
    ...
    if not df.empty:
        ...
        print(f"🧠 Arkham Gizi: %1 gibi mikro bir momentum bile 141 Sinyal veriyor!")
