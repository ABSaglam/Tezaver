"""
ARKMUSDT - Gizem Keşfi
=======================
Arkham - AI / Data Intelligence
28 DG Rallies.
AI sektöründen (FET, AGIX, WLD).
AI genelde Momentum sever ama ARKM bir 'Intel-to-Earn' platformu.
Bakalım karakteri ne?
...
def main():
    symbol = 'ARKMUSDT'
    print(f"🔍 {symbol} (Arkham) - AI Data Gizemi...")
    ...
    print("\n" + "="*70)
    print("⚡ AYIRICI GÜÇ - ARKM Farklı mı?")
    print("="*70)
