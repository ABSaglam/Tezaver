...
Altyapı coin'leri farklı mı? (MDT gibi?)
...
def main():
    symbol = 'ALTUSDT'
    print(f"🔍 {symbol} (AltLayer) - Infra Gizemi...")
    ...
    print(f"✓ {len(rally_results)} DG rallies (train) - Infra token.")
    ...
    print("\n" + "="*70)
    print("⚡ AYIRICI GÜÇ - ALT Farklı mı?")
    print("="*70)
