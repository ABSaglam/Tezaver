...
======================
Aptos - L1 Blockchain
15 DG Rallies (ALGO ile benzer, o çift karakterliydi)
Yeni nesil L1'ler nasıl davranıyor?
...
def main():
    symbol = 'APTUSDT'
    print(f"🔍 {symbol} (Aptos) - L1 Blockchain Gizemi...")
    ...
    print(f"✓ {len(rally_results)} DG rallies (train) - L1.")
    ...
    print("\n" + "="*70)
    print("⚡ AYIRICI GÜÇ - APT Farklı mı?")
    print("="*70)
