...
BATUSDT - Gizem Keşfi
======================
Basic Attention Token - Legacy Browser Token
Tahmini Rally Sayısı: Bilinmiyor (Kontrol edilecek)
Eski nesil (2017) coinlerden.
Genelde sessizdir ama boğada 1-2 kez sert hareket eder.
"Uykucu" (Dormant Pumper) olabilir.
...
def main():
    symbol = 'BATUSDT'
    print(f"🔍 {symbol} (Basic Attention) - Legacy Gizemi...")
    ...
    print("\n" + "="*70)
    print("⚡ AYIRICI GÜÇ - BAT Farklı mı?")
    print("="*70)
