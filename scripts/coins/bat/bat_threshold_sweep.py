"""
BATUSDT Threshold Sweep
=======================
Basic Attention Token - Legacy
Pattern Discovery:
mom_5d: +2.42% avg (+10352% fark!) -> Uyanış 🚀
mom_7d: +2.72% avg (+3279% fark)
164 DG Rallies.

BAT, sessizliğin bozulduğu anı seviyor.
Dip değil, momentum coini.

Test:
Momentum Awakening (mom >= 2, 3, 5)
"""
...
def main():
    symbol = 'BATUSDT'
    print(f"🔬 {symbol} (BAT) Threshold Sweep - Awakening")
    ...
    print("\n" + "="*70)
    print("🔬 BAT Strateji Testleri")
    print("="*70)
    
    # Test 1: Weekly Awakening (mom_7d)
    print("\n📊 Test 1: Weekly Awakening (mom_7d):")
    ...
    # Test 2: Medium Awakening (mom_5d)
    print("\n📊 Test 2: Medium Awakening (mom_5d):")
    for thresh in [2, 3, 5, 8]:
        signals = []
        for idx in range(25, len(df_1d)-1):
