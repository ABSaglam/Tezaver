"""
AVAXUSDT Threshold Sweep
========================
Avalanche - L1
Pattern Discovery:
mom_5d: +2.98% avg (+4875% fark!) -> Kısa Vade İvme 🚀
mom_7d: +4.54% avg (+3690% fark) -> Haftalık Trend
ema_dist: +1.27% avg (Trendde)

AVAX, klasik momentum coini. Düşerken değil, yükselirken alınmalı.
223 DG Rally var, yani çok fazla veri var.
Yüksek eşikler (3-5-8%) test edilebilir.
"""
...
def main():
    symbol = 'AVAXUSDT'
    print(f"🔬 {symbol} (Avalanche) Threshold Sweep - High Beta Momentum")
