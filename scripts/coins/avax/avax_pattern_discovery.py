"""
AVAXUSDT - Gizem Keşfi
=======================
Avalanche - Major L1
223 DG Rallies. (Yüksek)
AVAX, Solana (SOL) gibi "High Beta" bir L1.
Genelde piyasa dönerken en sert tepki verenlerden.
Momentum mu Dip mi?
...
def main():
    symbol = 'AVAXUSDT'
    print(f"🔍 {symbol} (Avalanche) - L1 Gizemi...")
    ...
    print("\n" + "="*70)
    print("⚡ AYIRICI GÜÇ - AVAX Farklı mı?")
    print("="*70)
