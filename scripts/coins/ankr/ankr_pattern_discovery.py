"""
ANKRUSDT - Gizem Keşfi
=======================
Ankr - Web3 Infrastructure
Ne saklıyor? (Diğer infra tokenlar (ALT) gibi dip-buying mi?)
...
def main():
    symbol = 'ANKRUSDT'
    print(f"🔍 {symbol} (Ankr) - Web3 Infra Gizemi...")
    ...
    print(f"✓ {len(rally_results)} DG rallies (train) - Infra.")
    ...
    print("\n" + "="*70)
    print("⚡ AYIRICI GÜÇ - ANKR Farklı mı?")
    print("="*70)
