"""
ANKRUSDT Threshold Sweep
=========================
Ankr - Web3 Infra
Pattern Discovery:
mom_7d: +7.31% avg (+2283% fark) -> King 👑
mom_5d: +4.83% avg (+2067% fark)
mom_3d: +2.18% avg (+1655% fark)
daily_ch: +1.10% avg (+1832% fark)

Güçlü momentum, özellikle haftalık trend (mom_7d).
"""
...
def main():
    symbol = 'ANKRUSDT'
    print(f"🔬 {symbol} (Ankr) Threshold Sweep - Momentum Focus")
