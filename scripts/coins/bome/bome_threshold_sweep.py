"""
BOMEUSDT Threshold Sweep
========================
Book of Meme - Meme Coin
Pattern Discovery:
daily_ch: -0.66% avg (-687% fark) -> Günlük Derin Dip
mom_3d: -1.64% avg (-294% fark) -> Kısa Vade Düşüş
223 DG Rallies.

BOME, meme coin olmasına rağmen "Dip Buyer" profili.
BLUR ile benzer.

Test:
Daily Dip (daily_ch <= -1, -2, -3)
...
def main():
    symbol = 'BOMEUSDT'
    print(f"🔬 {symbol} (BOME) Threshold Sweep - Meme Dip")
