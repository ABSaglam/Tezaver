"""
ARKUSDT Threshold Sweep
========================
Ark - Legacy L1
Pattern Discovery:
mom_5d: +11.26% avg (+41,209% fark!) -> Rekor Momentum 🚀
mom_7d: +15.90% avg (+22,678% fark)
mom_3d: +7.07% avg (+20,559% fark)

API3 gibi, ama daha da agresif bir momentum karakteri var.
"Gücü Satın Al" (Buy Strength) stratejisi.

Test:
Yüksek momentum eşikleri (mom_5d >= 10% gibi)
"""
...
def main():
    symbol = 'ARKUSDT'
    print(f"🔬 {symbol} (Ark) Threshold Sweep - Extreme Momentum")
    ...
    print("\n" + "="*70)
    print("🔬 ARK Strateji Testleri")
    print("="*70)
    
    # Test 1: Strong Medium Momentum (mom_5d - Pattern Lideri)
    print("\n📊 Test 1: Strong Medium Momentum (mom_5d):")
    ...
    # Test 2: Strong Long Momentum (mom_7d)
    print("\n📊 Test 2: Strong Long Momentum (mom_7d):")
    for thresh in [8, 10, 15, 18, 20]:
        signals = []
        for idx in range(25, len(df_1d)-1):
            row = df_1d.loc[idx]
