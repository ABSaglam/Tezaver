...
ARKUSDT - Gizem Keşfi
======================
Ark - Legacy L1 / Interop
37 DG Rallies (Yüksek sayı)
Eski coinler genelde oturmuş karakterlidir.
Momentum mu Dip mi?
...
def main():
    symbol = 'ARKUSDT'
    print(f"🔍 {symbol} (Ark) - Legacy Gizemi...")
    ...
    print("\n" + "="*70)
    print("⚡ AYIRICI GÜÇ - ARK Farklı mı?")
    print("="*70)
