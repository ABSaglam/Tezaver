"""
ARKUSDT Unique Strategy V1 (Final)
===================================
Ark - Legacy Momentum Rocket

GİZEM: Rekor Momentum (Extreme Momentum) 🚀
mom_7d >= 8% (76 Sinyal) -> %100 Kesinlik!

ARK, API3 gibi "Gücü Satın Al" coini ama çok daha agresif.
Haftalık %8 gibi yüksek bir eşik bile %100 çalışıyor.
Bu, coin trende girdiğinde çok sert gittiğini gösteriyor.
...
def main():
    symbol = 'ARKUSDT'
    print(f"🎯 {symbol} (Ark) UNIQUE STRATEGY V1")
    ...
    if not df.empty:
        ...
        print(f"🚀 Ark Gizi: %8 gibi yüksek bir haftalık eşik bile 76 Sinyal veriyor!")
