"""
BONKUSDT - Gizem Keşfi
=======================
Bonk - Solana Meme Coin
Tahmini Rally Sayısı: Bilinmiyor (Kontrol edilecek)
Solana ekosisteminin en popüler meme coini.
BOME ile aynı "Dip Buyer" mı?
...
def main():
    symbol = 'BONKUSDT'
    print(f"🔍 {symbol} (Bonk) - Solana Meme Gizemi...")
    ...
    if not rally_df.empty:
        print("\n" + "="*70)
        print("⚡ AYIRICI GÜÇ - BONK Farklı mı?")
        print("="*70)
