"""
BEAMXUSDT - Gizem Keşfi
========================
Beam (Merit Circle) - GameFi / Privacy
Tahmini Rally Sayısı: Bilinmiyor (Kontrol edilecek)
Yeni nesil GameFi (Merit Circle rebrand).
Hype odaklı (Launch) bir karakter mi yoksa oturmuş bir teknik mi?
...
def main():
    symbol = 'BEAMXUSDT'
    print(f"🔍 {symbol} (Beam) - GameFi Gizemi...")
    ...
    if not rally_df.empty:
        print("\n" + "="*70)
        print("⚡ AYIRICI GÜÇ - BEAMX Farklı mı?")
        print("="*70)
