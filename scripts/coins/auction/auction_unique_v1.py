"""
AUCTIONUSDT Unique Strategy V1 (Final)
=======================================
Bounce - Launchpad Momentum Rocket

GİZEM: Roket İvmesi (Launchpad Rocket) 🚀
mom_7d >= 5% (124 Sinyal) -> %100 Kesinlik!

AUCTION, Launchpad olmanın getirdiği volatilite ile çok sert hareket ediyor.
Haftalık %5 gibi sağlam bir ivme yakaladığında,
bunu genelde daha büyük bir patlama takip ediyor.
Dip (Pullback) beklemek yerine, trene hareket halindeyken binmek (Breakout/Momentum) daha karlı.
...
def main():
    symbol = 'AUCTIONUSDT'
    print(f"🎯 {symbol} (Bounce) UNIQUE STRATEGY V1")
    ...
    if not df.empty:
        ...
        print(f"🚀 AUCTION Gizi: %5 üzerinde güçlü momentum 124 Sinyal veriyor!")
