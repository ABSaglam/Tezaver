"""
AUCTIONUSDT Threshold Sweep
===========================
Bounce Token - Launchpad
Pattern Discovery:
mom_7d: +7.39% avg (+1328% fark) -> Güçlü İvme 🚀
mom_3d: +3.43% avg (+981% fark)
ema_dist: +2.34% avg (Fiyat ortalamadan çoktan uzaklaşmış)

AUCTION, rally öncesi zaten hareketlenmiş oluyor.
Test: Orta/Yüksek Momentum Eşikleri (3-8%)
"""
...
def main():
    symbol = 'AUCTIONUSDT'
    print(f"🔬 {symbol} (Bounce) Threshold Sweep - High Momentum")
    ...
    print("\n" + "="*70)
    print("🔬 AUCTION Strateji Testleri")
    print("="*70)
