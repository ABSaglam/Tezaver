"""
BTCUSDT Unique Strategy V1 (Final)
===================================
Bitcoin - Blue Chip Dip King

GİZEM: Mavi Çip Dip Kralı (Blue Chip Dip King) 👑
mom_7d <= 0% (15 Sinyal) -> %100 Kesinlik!

BTC, BNB ile aynı "Dip Buyer" profili!
Blue Chip Paradigm: Major coinlerde zayıfken al.
Haftalık momentum sıfır veya negatifken giriş.
...
def main():
    symbol = 'BTCUSDT'
    print(f"🎯 {symbol} (Bitcoin) UNIQUE STRATEGY V1")
    ...
    if not df.empty:
        ...
        print(f"👑 BTC Gizi: Haftalık momentum %0 veya altında = AL. Kral bile düşerken alınır. (15 Sinyal)")
