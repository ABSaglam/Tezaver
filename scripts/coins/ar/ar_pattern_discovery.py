...
15 DG Rallies.
Storage coinleri (FIL, STORJ) genelde nasıldır?
ALT (Infra) Dip-Buying sevdi. ANKR (Infra) Momentum sevdi. AR ne yapacak?
...
def main():
    symbol = 'ARUSDT'
    print(f"🔍 {symbol} (Arweave) - Storage Gizemi...")
    ...
    print(f"✓ {len(rally_results)} DG rallies (train) - Storage.")
    ...
    print("\n" + "="*70)
    print("⚡ AYIRICI GÜÇ - AR Farklı mı?")
    print("="*70)
