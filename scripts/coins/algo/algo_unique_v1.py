"""
ALGOUSDT Unique Strategy V1 (Final)
====================================
Algorand - L1 Momentum Beast with Dip-Buying Capabilities

GİZEM: ALGO çift kişilikli ama momentum baskın!
1. Momentum (mom_7d >= 10%) -> 50 sinyal ✅ (SEÇİLEN)
2. Dip-Buying (daily_ch <= -5%) -> 34 sinyal ✅
3. Hybrid (OR) -> 48 sinyal
...
def main():
    symbol = 'ALGOUSDT'
    print(f"🎯 {symbol} (Algorand) UNIQUE STRATEGY V1")
    ...
    for idx in range(25, len(df_1d)-1):
        ...
        # ALGO UNIQUE: Momentum focus (mom_7d)
        if row['mom_7d'] >= 10:
            ...
            if next_date in rally_results:
                ...
                if len(signals) <= 20 or len(signals) > 30:
    ...
    if not df.empty:
        ...
        print(f"🏛️ Algorand Gizi: Çift kişilikli (Mom+Dip) ama Momentum daha güçlü!")
