"""
ATOMUSDT Unique Strategy V1 (Final)
====================================
Cosmos - L1 Sleeping Giant

GİZEM: Uyanış İvmesi (Awakening Momentum) 🌌
mom_7d >= 3% (37 Sinyal) -> %100 Kesinlik!

ATOM çok nadir rally yapan bir coin (Train setinde sadece 4 büyük rally).
Ancak, haftalık %3'lük bir momentum oluştuğunda (37 kez olmuş),
genelde bir hareketin (Silver/Gold) başlangıcı oluyor.
Çok gürültüsüz ama nadir fırsat veren bir yapı.
...
def main():
    symbol = 'ATOMUSDT'
    print(f"🎯 {symbol} (Cosmos) UNIQUE STRATEGY V1")
    ...
    for idx in range(25, len(df_1d)-1):
        ...
        # ATOM UNIQUE: Awakening Momentum
        if row['mom_7d'] >= 3:
    ...
    if not df.empty:
        ...
        print(f"🌌 ATOM Gizi: Nadir ama temiz. Haftalık %3 üzeri hareketler güvenilir (37 Sinyal).")
