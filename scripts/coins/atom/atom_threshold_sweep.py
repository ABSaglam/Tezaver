"""
ATOMUSDT Threshold Sweep
========================
Cosmos - L1
⚠️ Sadece 4 DG Rally!
Pattern Discovery:
daily_ch: -0.95% (Hafif negatif)
mom_3d: -0.94% (Hafif negatif)

ATOM genelde çok yatay.
Küçük hareketlere (1-2%) odaklanırsak çok fazla "boş sinyal" (False Positive) alırız.
Bu yüzden DAHA GÜÇLÜ hareketleri test etmeliyiz.

Test:
1. Strong Dip (daily_ch <= -3, -5) -> Sert düşüş fırsat mı?
2. Strong Momentum (mom_7d >= 5, 8) -> Hareket başladığında mı girmeli?
"""
...
def main():
    symbol = 'ATOMUSDT'
    print(f"🔬 {symbol} (Cosmos) Threshold Sweep - Low Count Logic")
    ...
    print("\n" + "="*70)
    print("🔬 ATOM Strateji Testleri")
    print("="*70)
    
    # Test 1: Strong Dip (daily_ch)
    print("\n📊 Test 1: Strong Dip (daily_ch):")
