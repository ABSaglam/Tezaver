"""
ASTRUSDT - Gizem Keşfi
=======================
Astar - Polkadot / Smart Contracts
17 DG Rallies.
Polkadot ekosistemi genelde biraz daha ağırdır.
Momentum mu Dip mi?
...
def main():
    symbol = 'ASTRUSDT'
    print(f"🔍 {symbol} (Astar) - Polkadot Gizemi...")
    ...
    print("\n" + "="*70)
    print("⚡ AYIRICI GÜÇ - ASTR Farklı mı?")
    print("="*70)
