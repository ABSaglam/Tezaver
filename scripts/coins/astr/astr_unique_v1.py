"""
ASTRUSDT Unique Strategy V1 (Final)
====================================
Astar - Polkadot Deep Dip

GİZEM: Derin Dip (Deep Dip Rebound) 📉
daily_ch <= -2% (65 Sinyal) -> %100 Kesinlik!

ASTR, L1 blockchainler arasında (APT, ALGO gibi) dip severlerden.
Günlük %2'lik düşüşler bile alım fırsatı yaratıyor.
Hybrid stratejiye (Momentum + Dip) gerek kalmadan,
sadece "Düştüğünde Al" (Pure Dip) kuralı mükemmel çalışıyor.
...
def main():
    symbol = 'ASTRUSDT'
    print(f"🎯 {symbol} (Astar) UNIQUE STRATEGY V1")
    ...
    if not df.empty:
        ...
        print(f"📉 Astar Gizi: Günlük %2+ düşüşlerde alım fırsatı! (65 Sinyal)")
