"""
ATAUSDT Threshold Sweep
=======================
Automata Network - Middleware
Pattern Discovery:
mom_7d: +2.27% avg (+369% fark) -> Sessiz Yükseliş 🤫
mom_5d: +1.76% avg (+358% fark)
ARPA ile çok benzer profil.

Test:
Düşük Momentum Eşikleri (2-5%)
"""
...
def main():
    symbol = 'ATAUSDT'
    print(f"🔬 {symbol} (Automata) Threshold Sweep - Stealth Momentum")
