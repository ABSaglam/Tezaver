...
ATAUSDT - Gizem Keşfi
======================
Automata Network - Middleware / Privacy
18 DG Rallies.
ARPA (Privacy) sessiz çıkmıştı. ATA nasıl davranıyor?
Middleware coinleri bazen teknik (momentum) bazen sessiz (dip) olabiliyor.
...
def main():
    symbol = 'ATAUSDT'
    print(f"🔍 {symbol} (Automata) - Middleware Gizemi...")
    ...
    print("\n" + "="*70)
    print("⚡ AYIRICI GÜÇ - ATA Farklı mı?")
    print("="*70)
