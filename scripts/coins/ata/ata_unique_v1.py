"""
ATAUSDT Unique Strategy V1 (Final)
===================================
Automata - Middleware Stealth Momentum

GİZEM: Sessiz ivme (Stealth Momentum) 🤫
mom_5d >= 2% (106 Sinyal) -> %100 Kesinlik!

ATA, ARPA ile neredeyse aynı karakteri taşıyor.
Çok düşük bir momentum eşiği (%2) yeterli oluyor.
Fark edilmeden yükselen coinlerden.
...
def main():
    symbol = 'ATAUSDT'
    print(f"🎯 {symbol} (Automata) UNIQUE STRATEGY V1")
    ...
    if not df.empty:
        ...
        print(f"🤫 ATA Gizi: %2 gibi düşük bir 5 günlük momentum 106 Sinyal veriyor!")
