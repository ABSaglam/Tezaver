...
BNTUSDT - Gizem Keşfi
======================
Bancor - OG DeFi Protocol (2017)
Tahmini Rally Sayısı: Bilinmiyor (Kontrol edilecek)
İlk AMM protokollerinden biri.
Eski nesil DeFi, genelde sessiz ama boğada hareketlenir.
...
def main():
    symbol = 'BNTUSDT'
    print(f"🔍 {symbol} (Bancor) - OG DeFi Gizemi...")
    ...
    if not rally_df.empty:
        print("\n" + "="*70)
        print("⚡ AYIRICI GÜÇ - BNT Farklı mı?")
        print("="*70)
