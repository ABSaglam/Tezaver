"""
AMPUSDT Unique Strategy V1 (Final)
===================================
Amp - Collateral Token Momentum

GİZEM: Momentum King! 👑
mom_7d: +3531% fark (Çok güçlü)
mom_3d: +10682% fark (Keskin)

Seçilen: mom_7d >= 5% (81 Sinyal)
3-günlük momentum da çok iyi ama 7-günlük daha fazla sinyal (aynı %5 eşiğinde) veriyor.
...
def main():
    symbol = 'AMPUSDT'
    print(f"🎯 {symbol} (Amp) UNIQUE STRATEGY V1")
    ...
    for idx in range(25, len(df_1d)-1):
        ...
        # AMP UNIQUE: Long Momentum (trend follower)
        if row['mom_7d'] >= 5:
    ...
    if not df.empty:
        ...
        print(f"⚡ Amp Token Gizi: 7-günlük momentum kuralı %100 çalışıyor (81 Sinyal)!")
