...
AMPUSDT - Gizem Keşfi
======================
Amp - Collateral Token
51 DG Rallies! (Çok yüksek sayı - AGLD ve AI'dan sonra)
Bu kadar çok rally varsa, pattern çok net olmalı veya çok gürültülü.
...
def main():
    symbol = 'AMPUSDT'
    print(f"🔍 {symbol} (Amp) - Collateral Token Gizemi...")
    ...
    print(f"✓ {len(rally_results)} DG rallies (train) - ÇOK AKTİF!")
    ...
    print("\n" + "="*70)
    print("⚡ AYIRICI GÜÇ - AMP Farklı mı?")
    print("="*70)
