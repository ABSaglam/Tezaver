...
BCHUSDT - Gizem Keşfi
======================
Bitcoin Cash - Legacy PoW L1
Tahmini Rally Sayısı: Bilinmiyor (Kontrol edilecek)
BCH, Bitcoin'in fork'u.
Genelde BTC dominansıyla hareket eder ama "pump" dönemlerinde çok sertleşebilir.
Momentum mu Dip mi?
...
def main():
    symbol = 'BCHUSDT'
    print(f"🔍 {symbol} (Bitcoin Cash) - Legacy PoW Gizemi...")
    ...
    print("\n" + "="*70)
    print("⚡ AYIRICI GÜÇ - BCH Farklı mı?")
    print("="*70)
