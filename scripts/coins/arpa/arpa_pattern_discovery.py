"""
ARPAUSDT - Gizem Keşfi
=======================
ARPA - Privacy / Computation
26 DG Rallies.
Gizlilik odaklı coinler (Privacy) genelde sessiz gider, aniden patlar.
Karakteri ne? Dip mi Momentum mu?
...
def main():
    symbol = 'ARPAUSDT'
    print(f"🔍 {symbol} (ARPA) - Privacy Gizemi...")
    ...
    print("\n" + "="*70)
    print("⚡ AYIRICI GÜÇ - ARPA Farklı mı?")
    print("="*70)
