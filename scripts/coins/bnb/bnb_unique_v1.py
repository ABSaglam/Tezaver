"""
BNBUSDT Unique Strategy V1 (Final)
===================================
Binance Coin - Blue Chip Dip Buyer

GİZEM: Mavi Çip Dip Avcısı (Blue Chip Dip) 🔵
daily_ch <= 0% (20 Sinyal) -> %100 Kesinlik!

BNB, piyasanın en büyük coinlerinden biri.
Ama momentum ile değil, DİP ile rally yapıyor!
Kırmızı mum günü (günlük %0 veya altı) alım sinyali.

Bu, "korkudan satma, korkudan al" stratejisi.
Blue chip'lerde panik satışları fırsat yaratıyor.
...
def main():
    symbol = 'BNBUSDT'
    print(f"🎯 {symbol} (Binance Coin) UNIQUE STRATEGY V1")
    ...
    if not df.empty:
        ...
        print(f"🔵 BNB Gizi: Kırmızı mum günü AL. Blue chip'lerde panik = fırsat. (20 Sinyal)")
