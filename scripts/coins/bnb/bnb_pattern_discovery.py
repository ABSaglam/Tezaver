...
BNBUSDT - Gizem Keşfi
======================
Binance Coin - Major L1 / Exchange Token
Tahmini Rally Sayısı: Bilinmiyor (Kontrol edilecek)
BNB, piyasanın en likit ve güçlü coinlerinden.
Genelde BTC ile korelasyon gösterir ama bağımsız pump dönemleri de var.
Blue Chip karakteri mi?
...
def main():
    symbol = 'BNBUSDT'
    print(f"🔍 {symbol} (Binance Coin) - Blue Chip Gizemi...")
    ...
    if not rally_df.empty:
        print("\n" + "="*70)
        print("⚡ AYIRICI GÜÇ - BNB Farklı mı?")
        print("="*70)
