"""
BICOUSDT Unique Strategy V1 (Final)
====================================
Biconomy - Quiet Momentum

GİZEM: Sessiz İvme (Quiet Momentum) 🤫
mom_7d >= 1% (124 Sinyal) -> %100 Kesinlik!

BICO, düşük yoğunluklu bir momentum coini.
Haftalık momentum sadece %1'e çıktığında bile sinyal veriyor.
Bu, BICO'nun çok hassas bir "mikro-trend" takipçisi olduğunu gösteriyor.
...
def main():
    symbol = 'BICOUSDT'
    print(f"🎯 {symbol} (Biconomy) UNIQUE STRATEGY V1")
    ...
    if not df.empty:
        ...
        print(f"🤫 BICO Gizi: %1 ivme bile yeterli. Hassas mikro-trend takipçisi. (124 Sinyal)")
