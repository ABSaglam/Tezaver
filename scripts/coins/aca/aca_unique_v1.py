"""
ACAUSDT Unique Strategy V1 (Final)
===================================
ACA-Specific Strategy: 3-Day Momentum Focus

Discovery: ACA's strongest discriminator is mom_3d (+771% difference)
Simple single-threshold strategy provides 100% precision with excellent signal count.

Final Rules:
- mom_3d >= 15%

Trained on: 2023-2025 data (2026 held out for testing)
"""
...
def main():
    ...
    if not df.empty:
        ...
        print(f"\n📌 2026 data (19 days) held out for testing")
