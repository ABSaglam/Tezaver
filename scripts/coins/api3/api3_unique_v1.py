"""
API3USDT Unique Strategy V1 (Final)
====================================
API3 - Oracle Token Momentum Monster

GİZEM: Buy Strength (Gücü Satın Al) 🐂
mom_7d >= 5% (96 Sinyal) -> %100 Kesinlik!
Bu coin trende girdiğinde arkasına bakmıyor.
3-günlük ve günlük momentum da çok güçlü ama 7-günlük en yüksek sinyal sayısını (96) veriyor.
...
def main():
    symbol = 'API3USDT'
    print(f"🎯 {symbol} (API3) UNIQUE STRATEGY V1")
    ...
    for idx in range(25, len(df_1d)-1):
        ...
        # API3 UNIQUE: Long Momentum (Trend Monster)
        if row['mom_7d'] >= 5:
    ...
    if not df.empty:
        ...
        print(f"🔮 API3 Gizi: 96 Sinyal ile rekor kırıyor! Tam bir momentum canavarı.")
