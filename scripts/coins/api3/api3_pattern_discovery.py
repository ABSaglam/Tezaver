"""
API3USDT - Gizem Keşfi
=======================
API3 - Oracle Token
35 DG Rallies! (İyi bir sayı)
Oracle tokenları (LINK gibi) bazen öncü olabilir.
Bakalım karakteri Momentum mu, Dip-Buying mi?
...
def main():
    symbol = 'API3USDT'
    print(f"🔍 {symbol} (API3) - Oracle Gizemi...")
    ...
    print(f"✓ {len(rally_results)} DG rallies (train) - Oracle.")
    ...
    print("\n" + "="*70)
    print("⚡ AYIRICI GÜÇ - API3 Farklı mı?")
    print("="*70)
