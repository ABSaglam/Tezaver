"""
BELUSDT Unique Strategy V1 (Final)
===================================
Bella Protocol - Momentum Rider

GİZEM: İvme Avcısı (Momentum Hunter) 🏹
mom_5d >= 2% (125 Sinyal) -> %100 Kesinlik!

BEL, çok aktif bir DeFi coini (260 Rally).
5 günlük momentum %2'yi geçtiğinde alım yapılmalı.
Tüm momentum göstergeleri aynı yönü işaret ediyor: Güçlüyken AL.
...
def main():
    symbol = 'BELUSDT'
    print(f"🎯 {symbol} (Bella) UNIQUE STRATEGY V1")
    ...
    if not df.empty:
        ...
        print(f"🏹 BEL Gizi: 5 günlük %2 ivme görünce AL. Basit ama etkili. (125 Sinyal)")
