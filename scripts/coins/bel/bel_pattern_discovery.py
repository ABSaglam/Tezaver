...
BELUSDT - Gizem Keşfi
======================
Bella Protocol - DeFi Aggregator
Tahmini Rally Sayısı: Bilinmiyor (Kontrol edilecek)
Eski DeFi (2020) coinlerinden.
Genelde sessiz ama pump dönemlerinde agresif olabilir.
...
def main():
    symbol = 'BELUSDT'
    print(f"🔍 {symbol} (Bella) - DeFi Gizemi...")
    ...
    if not rally_df.empty:
        print("\n" + "="*70)
        print("⚡ AYIRICI GÜÇ - BEL Farklı mı?")
        print("="*70)
