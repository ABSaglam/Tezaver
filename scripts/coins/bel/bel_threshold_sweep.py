"""
BELUSDT Threshold Sweep
=======================
Bella Protocol - DeFi
Pattern Discovery:
mom_7d: +2.65% avg (+727% fark) -> Momentum 🚀
mom_5d: +2.38% avg (+651% fark)
mom_3d: +1.02% avg (+791% fark)
260 DG Rallies.

BEL, net bir Momentum coini.
Tüm momentumlar pozitif.

Test:
Momentum (mom_7d >= 2, 3, 5)
"""
...
def main():
    symbol = 'BELUSDT'
    print(f"🔬 {symbol} (Bella) Threshold Sweep - Momentum Rider")
