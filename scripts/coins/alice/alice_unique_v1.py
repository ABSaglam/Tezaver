"""
ALICEUSDT Unique Strategy V1 (Final)
=====================================
My Neighbor Alice - Gaming Momentum with Hidden Depths

GİZEM: Karışık sinyaller çözüldü!
Hem momentum hem dip-buying çalışıyor.
En yüksek verim: mom_7d >= 5% (75 sinyal)

Gaming token (AGLD) gibi güçlü momentum, ama dip fırsatları da veriyor.
Seçim: Basitlik ve maksimum sinyal için Momentum.
...
def main():
    symbol = 'ALICEUSDT'
    print(f"🎯 {symbol} (Gaming) UNIQUE STRATEGY V1")
    ...
    for idx in range(25, len(df_1d)-1):
        ...
        # ALICE UNIQUE: Long Momentum (Gaming sektörü trend sever)
        if row['mom_7d'] >= 5:
            ...
            if next_date in rally_results:
                ...
                if len(signals) <= 20 or len(signals) > 55:
    ...
    if not df.empty:
        ...
        print(f"🎮 Metaverse Gizi: Gaming coinleri trend takipçisi (AGLD & ALICE momentumcu)!")
