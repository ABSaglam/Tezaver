"""
APEUSDT Threshold Sweep
========================
ApeCoin - NFT/Metaverse
Pattern Discovery:
daily_ch: -2.31% avg (-1268% fark) -> Dip Buying? 📉
mom_3d: -2.52% avg (-396% fark)
mom_5d: +1.41% avg (Pozitif, ama zayıf)

ALICE (Gaming) momentumcuydu, APE (NFT) ise dipçi görünüyor.
Test: Dip Buying vs Momentum
"""
...
def main():
    symbol = 'APEUSDT'
    print(f"🔬 {symbol} (ApeCoin) Threshold Sweep - Dip vs Momentum")
    ...
    # Test 3: Momentum Check (Just in case)
    print("\n📊 Test 3: Momentum Check (mom_7d):")
