...
APEUSDT - Gizem Keşfi
======================
ApeCoin - NFT/Metaverse
10 DG Rallies (Düşük sayı) - Veri az ama değerli olabilir.
Gaming/Metaverse coinleri (ALICE, AGLD) momentum seviyor. APE nasıl?
...
def main():
    symbol = 'APEUSDT'
    print(f"🔍 {symbol} (ApeCoin) - NFT/Metaverse Gizemi...")
    ...
    print(f"✓ {len(rally_results)} DG rallies (train) - Düşük sayı.")
    ...
    print("\n" + "="*70)
    print("⚡ AYIRICI GÜÇ - APE Farklı mı?")
    print("="*70)
