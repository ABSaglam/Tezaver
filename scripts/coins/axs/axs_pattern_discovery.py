...
AXSUSDT - Gizem Keşfi
======================
Axie Infinity - GameFi King
9 DG Rallies. (Düşük Sayı)
Efsanevi boğa koşusundan (2021) sonra sessizleşti.
Hala hareket ediyor mu?
Hareket ettiğinde nasıl başlıyor?
Momentum mu Dip mi?
...
def main():
    symbol = 'AXSUSDT'
    print(f"🔍 {symbol} (Axie) - GameFi Gizemi...")
    ...
    print("\n" + "="*70)
    print("⚡ AYIRICI GÜÇ - AXS Farklı mı?")
    print("="*70)
