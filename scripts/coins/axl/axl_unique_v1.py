"""
AXLUSDT Unique Strategy V1 (Final)
===================================
Axelar - Interop Deep Dip

GİZEM: Derin Çöküş (Deep Weekly Dip) 📉
mom_7d <= -3% (94 Sinyal) -> %100 Kesinlik!

AXL, momentumu sevmeyen, aksine korkuyu seven bir coin.
Haftalık %3 ve üzeri kayıplarda (Kırmızı Ekran) alım fırsatı veriyor.
AXS ve AUDIO ile benzer aileden ama bir tık daha derin düşüş istiyor.
...
def main():
    symbol = 'AXLUSDT'
    print(f"🎯 {symbol} (Axelar) UNIQUE STRATEGY V1")
    ...
    if not df.empty:
        ...
        print(f"📉 AXL Gizi: Haftalık %3 üzeri düşüşlerde (Kırmızı) alım fırsatı! (94 Sinyal)")
