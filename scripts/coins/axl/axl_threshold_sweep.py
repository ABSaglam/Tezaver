"""
AXLUSDT Threshold Sweep
=======================
Axelar - Interop
Pattern Discovery:
mom_7d: -4.28% avg (Çok Negatif) -> Derin Dip 📉
mom_3d: -3.34% avg (Çok Negatif)
daily_ch: -1.67% avg (Negatif)
180 DG Rallies (Yüksek Sayı - 9 Yanlış Bilgiymiş)

AXL, momentum beklemeden, fiyat iyice düştüğünde alınmalı.
Test:
Deep Dip Buying (mom_7d <= -3, -5, -8)
"""
...
def main():
    symbol = 'AXLUSDT'
    print(f"🔬 {symbol} (Axelar) Threshold Sweep - Deep Dip")
    ...
    print("\n" + "="*70)
    print("🔬 AXL Strateji Testleri")
    print("="*70)
    
    # Test 1: Weekly Deep Dip (mom_7d - Pattern Lideri)
    print("\n📊 Test 1: Weekly Deep Dip (mom_7d):")
    ...
    # Test 2: Daily Deep Dip (daily_ch)
    print("\n📊 Test 2: Daily Deep Dip (daily_ch):")
