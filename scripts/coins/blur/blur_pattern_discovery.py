"""
BLURUSDT - Gizem Keşfi
=======================
Blur - NFT Marketplace
Tahmini Rally Sayısı: Bilinmiyor (Kontrol edilecek)
2023'te çıkan yeni nesil NFT marketplace coini.
OpenSea rakibi.
Hype odaklı mı, yoksa teknik mi?
...
def main():
    symbol = 'BLURUSDT'
    print(f"🔍 {symbol} (Blur) - NFT Marketplace Gizemi...")
    ...
    if not rally_df.empty:
        print("\n" + "="*70)
        print("⚡ AYIRICI GÜÇ - BLUR Farklı mı?")
        print("="*70)
