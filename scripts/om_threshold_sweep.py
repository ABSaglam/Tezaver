"""
OMUSDT Threshold Sweep
=======================
Finds the 100% precision threshold for OM based on its unique discriminators.
OM Key: ema_dist has massive separation (8404%!)
"""
...
def main():
    ...
    print("="*80)
    print("🔬 OMUSDT THRESHOLD SWEEP (ema_dist focus)")
    print("="*80)
