...
all_o_coins = [
    "OGNUSDT", "OGUSDT", "OMUSDT", "ONDOUSDT", "ONEUSDT", 
    "ONGUSDT", "ONTUSDT", "OPENUSDT", "OPUSDT", "ORCAUSDT", 
    "ORDIUSDT", "OSMOUSDT", "OXTUSDT"
]

report_file = "O_SERISI_OZET_RAPORU.md"
...
with open(report_file, "w") as f:
    f.write("# 🚇 AYAŞ TÜNELİ v4: O SERİSİ TOPLU RAPORU\n\n")
    f.write(f"**Rapor Tarihi:** 2026-01-21\n")
    f.write("**Kapsam:** O Harfi ile Başlayan Tüm Koinler\n\n")
    f.write("---\n\n")

    for symbol in all_o_coins:
