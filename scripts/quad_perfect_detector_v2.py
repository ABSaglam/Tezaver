"""
Quadratic Cluster Perfect Detector V2
=====================================
Target: 100% Precision.
Update: DNA > 0.90 + EMA_DIST > 10% + SUSTAINED 1H HEAT (>= 6 hours).
Tested against both Train and Blind Test zones.
"""
...
def main():
    ...
    for symbol in symbols:
        ...
        for idx in range(25, len(df_1d)-1):
            ...
            # V2 RULES: High Sustain Heat + EMA Distance
            if score > 0.90 and row_1d['ema_dist'] > 10.0 and w_row['w_slope'] > 0:
    ...
    print("\n" + "="*50)
    print("🎯 FINAL RECAP V2: 4-COIN CLUSTER")
    print("="*50)
    if not df.empty:
