...
all_d_coins = [
    ...
    "DUSKUSDT", "DYDXUSDT", "DYMUSDT"
]

report_file = "D_SERISI_OZET_RAPORU.md"
...
with open(report_file, "w") as f:
    f.write("# 🚇 AYAŞ TÜNELİ v4: D SERİSİ TOPLU RAPORU\n\n")
    f.write(f"**Rapor Tarihi:** 2026-01-21\n")
    f.write("**Kapsam:** D Harfi ile Başlayan Tüm Koinler\n\n")
    f.write("---\n\n")

    for symbol in all_d_coins:
