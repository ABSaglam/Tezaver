...
AIUSDT - Gizem Keşfi
=====================
AI Token - Teknoloji sektörü
AI token'lar farklı mı? Keşif zamanı.
...
def main():
    symbol = 'AIUSDT'
    print(f"🔍 {symbol} (AI Token) - Teknoloji Gizemi...")
    ...
    print(f"✓ {len(rally_results)} DG rallies (train) - AI hype etkisi var mı?")
    ...
    print("\n" + "="*70)
    print("⚡ AYIRICI GÜÇ - AI Token Özel mi?")
    print("="*70)
