...
all_i_coins = [
    ...
    "IOTXUSDT", "IOUSDT", "IQUSDT"
]

report_file = "I_SERISI_OZET_RAPORU.md"
...
with open(report_file, "w") as f:
    f.write("# 🚇 AYAŞ TÜNELİ v4: I SERİSİ TOPLU RAPORU\n\n")
    f.write(f"**Rapor Tarihi:** 2026-01-21\n")
    f.write("**Kapsam:** I Harfi ile Başlayan Tüm Koinler\n\n")
    f.write("---\n\n")

    for symbol in all_i_coins:
