...
ADAUSDT - Gizem Keşfi  
======================
Cardano - Büyük market cap coin
Ne saklar? Keşfedelim.
...
def main():
    symbol = 'ADAUSDT'
    print(f"🔍 {symbol} (Cardano) - Gizem Avcılığı...")
    ...
    print(f"✓ {len(rally_results)} DG rallies (train) - Cardano büyük coin, az rally mi?")
    ...
    print("\n" + "="*70)
    print(f"🎯 {symbol} - Cardano Gizmi")
    print(f"Rally Günleri: {len(rally_df)} | Normal: {len(non_rally_df)}")
    print("="*70)
    ...
    print("\n" + "="*70)
    print("⚡ AYIRICI GÜÇ - Cardano'nun DNA'sı")
    print("="*70)
