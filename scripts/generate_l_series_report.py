...
all_l_coins = [
    "LAUSDT", "LAYERUSDT", "LAZIOUSDT", "LDOUSDT", "LINEAUSDT", 
    "LINKUSDT", "LISTAUSDT", "LPTUSDT", "LQTYUSDT", "LRCUSDT", 
    "LSKUSDT", "LTCUSDT", "LUMIAUSDT", "LUNAUSDT", "LUNCUSDT"
]

report_file = "L_SERISI_OZET_RAPORU.md"
...
with open(report_file, "w") as f:
    f.write("# 🚇 AYAŞ TÜNELİ v4: L SERİSİ TOPLU RAPORU\n\n")
    f.write(f"**Rapor Tarihi:** 2026-01-21\n")
    f.write("**Kapsam:** L Harfi ile Başlayan Tüm Koinler\n\n")
    f.write("---\n\n")

    for symbol in all_l_coins:
