...
all_w_coins = [
    "WALUSDT", "WANUSDT", "WAXPUSDT", "WBETHUSDT", "WBTCUSDT", 
    "WCTUSDT", "WIFUSDT", "WINUSDT", "WLDUSDT", "WLFIUSDT", 
    "WOOUSDT", "WUSDT"
]

report_file = "W_SERISI_OZET_RAPORU.md"
...
with open(report_file, "w") as f:
    f.write("# 🚇 AYAŞ TÜNELİ v4: W SERİSİ TOPLU RAPORU\n\n")
    f.write(f"**Rapor Tarihi:** 2026-01-21\n")
    f.write("**Kapsam:** W Harfi ile Başlayan Tüm Koinler\n\n")
    f.write("---\n\n")

    for symbol in all_w_coins:
