...
# FDUSDUSDT belongs to F
all_f_coins = [
    "FARMUSDT", "FDUSDUSDT", "FETUSDT", "FFUSDT", "FIDAUSDT", 
    "FILUSDT", "FIOUSDT", "FLOKIUSDT", "FLOWUSDT", "FLUXUSDT", 
    "FOGOUSDT", "FORMUSDT", "FORTHUSDT", "FRAXUSDT", "FTTUSDT", 
    "FUNUSDT", "FUSDT"
]

report_file = "F_SERISI_OZET_RAPORU.md"
...
with open(report_file, "w") as f:
    f.write("# 🚇 AYAŞ TÜNELİ v4: F SERİSİ TOPLU RAPORU\n\n")
    f.write(f"**Rapor Tarihi:** 2026-01-21\n")
    f.write("**Kapsam:** F Harfi ile Başlayan Tüm Koinler\n\n")
    f.write("---\n\n")

    for symbol in all_f_coins:
