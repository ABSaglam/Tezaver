...
all_v_coins = [
    "VANAUSDT", "VANRYUSDT", "VELODROMEUSDT", "VETUSDT", "VICUSDT", 
    "VIRTUALUSDT", "VTHOUSDT"
]

report_file = "V_SERISI_OZET_RAPORU.md"
...
with open(report_file, "w") as f:
    f.write("# 🚇 AYAŞ TÜNELİ v4: V SERİSİ TOPLU RAPORU\n\n")
    f.write(f"**Rapor Tarihi:** 2026-01-21\n")
    f.write("**Kapsam:** V Harfi ile Başlayan Tüm Koinler\n\n")
    f.write("---\n\n")

    for symbol in all_v_coins:
