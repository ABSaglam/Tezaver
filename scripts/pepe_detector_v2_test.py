"""
PEPEUSDT Vol-Expansion Detector V2
===================================
Logic: PEPE needs 'Expansion' momentum, not a 'Squeeze'.
Filters: DNA > 0.65 + BB Squeeze > 1.1 + Weekly MACD Slope > 0.
"""
...
def main():
    ...
    for idx in range(25, len(df_1d)-1):
        ...
        # V2 FILTERS (Expansion Logic)
        f_dna = (best_score > 0.65)
        f_week = (w_row['macd_slope'] > 0)
        f_expansion = (row_1d['bb_sq'] > 1.10)
        f_4h = (b4['rsi'] < 85)
        
        if f_dna and f_week and f_expansion and f_4h:
    ...
    print("\n" + "="*80)
    print(f"🐸 PEPEUSDT EXPANSION DETECTOR V2")
    print("="*80)
