"""
ACEUSDT Unique Strategy V1 (Final)
===================================
ACE-Specific Strategy: 3-Day Momentum Focus

Discovery: ACE's strongest discriminators are daily_ch (+565%) and mom_3d (+443%)
Simple single-threshold on mom_3d provides excellent coverage.
