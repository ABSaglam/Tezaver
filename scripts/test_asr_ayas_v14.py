...
def scan_asr_ayas_days():
    ...
    for day in pass_days:
        ...
        # Convert dt to string for JSON mock
        ...
        # Ensure df_1h has 'timestamp' index not 'dt' for ASM compat if needed, 
        # but ASM v14 uses df_h1 index directly.
