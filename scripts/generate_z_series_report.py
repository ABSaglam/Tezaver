...
all_z_coins = [
    "ZBTUSDT", "ZECUSDT", "ZENUSDT", "ZILUSDT", "ZKCUSDT", 
    "ZKPUSDT", "ZKUSDT", "ZROUSDT", "ZRXUSDT"
]

report_file = "Z_SERISI_OZET_RAPORU.md"
...
with open(report_file, "w") as f:
    f.write("# 🚇 AYAŞ TÜNELİ v4: Z SERİSİ TOPLU RAPORU (FİNAL)\n\n")
    f.write(f"**Rapor Tarihi:** 2026-01-21\n")
    f.write("**Kapsam:** Z Harfi ile Başlayan Tüm Koinler\n\n")
    f.write("---\n\n")

    for symbol in all_z_coins:
