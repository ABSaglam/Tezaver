...
all_t_coins = [
    "TAOUSDT", "TFUELUSDT", "THETAUSDT", "THEUSDT", "TIAUSDT", 
    "TKOUSDT", "TLMUSDT", "TNSRUSDT", "TONUSDT", "TOWNSUSDT", 
    "TRBUSDT", "TREEUSDT", "TRUMPUSDT", "TRUUSDT", "TRXUSDT", 
    "TSTUSDT", "TURBOUSDT", "TURTLEUSDT", "TUSDT", "TUSDUSDT", 
    "TUTUSDT", "TWTUSDT"
]

report_file = "T_SERISI_OZET_RAPORU.md"
...
with open(report_file, "w") as f:
    f.write("# 🚇 AYAŞ TÜNELİ v4: T SERİSİ TOPLU RAPORU\n\n")
    f.write(f"**Rapor Tarihi:** 2026-01-21\n")
    f.write("**Kapsam:** T Harfi ile Başlayan Tüm Koinler\n\n")
    f.write("---\n\n")

    for symbol in all_t_coins:
