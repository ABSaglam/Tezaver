...
# EDEN belongs to E, FARM/FET/FF belong to F
all_e_coins = [
    "EDENUSDT", "EDUUSDT", "EGLDUSDT", "EIGENUSDT", "ENAUSDT", 
    "ENJUSDT", "ENSOUSDT", "ENSUSDT", "EPICUSDT", "ERAUSDT", 
    "ETCUSDT", "ETHFIUSDT", "ETHUSDT", "EULUSDT", "EURIUSDT", 
    "EURUSDT"
]

report_file = "E_SERISI_OZET_RAPORU.md"
...
with open(report_file, "w") as f:
    f.write("# 🚇 AYAŞ TÜNELİ v4: E SERİSİ TOPLU RAPORU\n\n")
    f.write(f"**Rapor Tarihi:** 2026-01-21\n")
    f.write("**Kapsam:** E Harfi ile Başlayan Tüm Koinler\n\n")
    f.write("---\n\n")

    for symbol in all_e_coins:
