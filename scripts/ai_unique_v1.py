"""
AIUSDT Unique Strategy V1 (Final)
==================================
AI Token - Dip-Buying Champion!

GİZEM: AI token = YENİ REKOR!
daily_ch <= -2% → 95 sinyal (AGLD'yi geçtik!)

4. dip-buying coin - AI hype düşüş günlerinde rally başlatıyor!
...
def main():
    symbol = 'AIUSDT'
    print(f"🎯 {symbol} (AI) UNIQUE STRATEGY V1")
    ...
    for idx in range(25, len(df_1d)-1):
        ...
        # AI UNIQUE: Dip-buying (AI hype düşünce al!)
        if row['daily_ch'] <= -2:
            ...
            if next_date in rally_results:
                ...
                if len(signals) <= 20 or len(signals) > 75:  # İlk 20 ve son 20'yi göster
    ...
    if not df.empty:
        ...
        print(f"🤖 AI Token Gizi: Dip-buying CHAMPION - 95 sinyal!")
