...
DATA_DIR = Path("/Users/alisaglam/TezaverMac/coin_cells/A2ZUSDT/data")
...
def check_dates():
    ...
    if min_date_15 > pd.Timestamp("2025-01-01", tz='UTC'):
        print(f"FAIL: 15M data starts too late ({min_date_15.date()} > 2025-01-01)")
        return
